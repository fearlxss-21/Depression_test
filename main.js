...
const MbtiModule = (function() {
	let types = {
		ISTJ: {title: "", percentage: "نسبة إصابتك بالاكتئاب متوسطة", description: "", site: ""},
		ENTJ: {title: "", percentage: "نسبة إصابتك بالاكتئاب متوسطة", description: "", site: ""},
		INTJ: {title: "", percentage: "", description: "نسبة إصابتك بالاكتئاب ضعيفة", site: ""},
		ESTJ: {title: "نسبة إصابتك بالاكتئاب عالية", percentage: "", description: "", site: ""},
	};
...
let description = document.querySelector('#type-description');
if (description) {
    description.style.color = '#7CFC00';
}

let percentage = document.querySelector('#type-percentage');
if (percentage) {
    percentage.style.color = '#FFA500';
}
